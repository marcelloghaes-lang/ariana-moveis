        ...
        <div class="flex items-center flex-shrink-0 min-w-0 md:min-w-[330px] pr-2 gap-3 overflow-visible">
          <a href="/" class="relative group flex items-center">
            <img 
              ...
              alt="Ariana Móveis"
              class="w-28 h-28 md:w-36 md:h-36 object-contain bg-transparent transition-transform duration-300 group-hover:scale-[1.10]" style="margin-top:-26px;margin-bottom:-26px;position:relative;z-index:5;"
            >
            <span
