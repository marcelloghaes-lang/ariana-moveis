...
function evolutionConfig(){return{base:clean(process.env.ERP_COLLECTION_EVOLUTION_API_URL||process.env.ARIANA_EVOLUTION_API_URL||process.env.EVOLUTION_API_URL||process.env.EVOLUTION_URL,500).replace(/\/+$/,''),apiKey:clean(process.env.ERP_COLLECTION_EVOLUTION_API_KEY||process.env.ARIANA_EVOLUTION_API_KEY||process.env.EVOLUTION_API_KEY||process.env.EVOLUTION_GLOBAL_API_KEY,500),instance:clean(process.env.ERP_COLLECTION_EVOLUTION_INSTANCE||process.env.ARIANA_SAC_EVOLUTION_INSTANCE||process.env.EVOLUTION_SAC_INSTANCE||'Ariana_SAC',180),senderPhone:digits(process.env.ERP_COLLECTION_SENDER_PHONE||'5531985147119')}}
