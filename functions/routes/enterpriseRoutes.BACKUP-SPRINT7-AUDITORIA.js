...
// ============================================================
// ROTAS ENTERPRISE - ARIANA MÃƒâ€œVEIS
// Objetivo: isolar homologaÃƒÂ§ÃƒÂ£o, parceiros, OpenAPI, SDKs e APIs Enterprise
...
// ============================================================
// CORREÃƒâ€¡ÃƒÆ’O ENTERPRISE - API KEY SANDBOX DINÃƒâ€šMICA
// MantÃƒÂ©m o mÃƒÂ³dulo antigo, mas garante que o API Explorer consiga
// autenticar e executar o fluxo completo usando as chaves geradas
// na homologaÃƒÂ§ÃƒÂ£o do painel.
// ============================================================
...
// ============================================================
// ETAPA 4 - ENTERPRISE RMA / DEVOLUÃƒâ€¡Ãƒâ€¢ES
...
// ============================================================
// BLOCO 4 Ã¢â‚¬â€ CREDENCIAIS ENTERPRISE (ADMIN)
// Rotas administrativas adicionadas sem alterar as rotas jÃƒÂ¡ validadas
...
// ConfiguraÃƒÂ§ÃƒÂ£o de URL, Secret HMAC, teste real e reenvio.
// ============================================================
...
// ============================================================
// CORREÃƒâ€¡ÃƒÆ’O ETAPA 2 Ã¢â‚¬â€ ROTAS REAIS DE HISTORY E SUMMARY
// Adiciona somente as rotas faltantes, sem alterar rotas jÃƒÂ¡ homologadas.
// ============================================================
...
// ============================================================
// SIGE CLOUD -> VENDA/PEDIDO PARA EMISSÃƒÆ’O MANUAL DE NF-e
// Fluxo seguro: Ariana cria a venda no SIGE, vocÃƒÂª emite a NF-e
// manualmente no SIGE, e depois o backend sincroniza XML/DANFE.
// Este mÃƒÂ³dulo ÃƒÂ© incremental e nÃƒÂ£o altera rotas antigas.
