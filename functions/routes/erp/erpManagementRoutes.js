...
export default function createErpManagementRoutes(context={}){
 ...
 router.post('/erp/financeiro/lancamentos/:id/quitar',context.adminRequired,handle(async req=>{const body={...(req.body||{}),__operation:'pay'};await settings.assertFinanceMutation(req.params.id,body);delete body.__operation;return{entry:await ledger.pay(req.params.id,body,actor(req))}}));
