...
// Rodocap fica desligada por padrão para testes da Frenet.
// Só volta a aparecer se RODOCAP_ENABLED=true estiver configurado no Render.
merged.businessRules = merged.businessRules || {};
merged.businessRules.rodocap = { ...((DEFAULT_SHIPPING_SETTINGS.businessRules || {}).rodocap || {}), ...((merged.businessRules || {}).rodocap || {}) };
merged.businessRules.rodocap.enabled = String(process.env.RODOCAP_ENABLED || '').toLowerCase() === 'true';
